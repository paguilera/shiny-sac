...
shinyUI(fluidPage(
  ...
  mainPanel(
      ...
      tags$footer("Disclaimer: This prediction function is provided for illustration purposes only and is not intended for use as a substitute for trained medical examination or evaluation. For serious diabetes care, please contact your primary care physician or other medical professional.")
  )
))
